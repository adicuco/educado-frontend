            ...
            <div className="bg-white rounded p-12 shadow-lg mt-12">
                <div className='flex flex-col divide text-gray-700'>
                    <form className="flex flex-col" action="">
                        ...
                        <input className="flex items-center h-12 px-4 w-64 bg-gray-100 mt-2 rounded focus:outline-none focus:ring-2" type="text" />
                        <label className="font-semibold text-xs mt-3" htmlFor="passwordField">Password</label>
                        <input className="flex items-center h-12 px-4 w-64 bg-gray-100 mt-2 rounded focus:outline-none focus:ring-2" type="password" />
