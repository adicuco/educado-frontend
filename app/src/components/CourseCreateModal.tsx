  ...
  return (
    <div className='absolute top-0 left-0 w-screen h-screen bg-black/60'>
      <div className='absolute w-1/3 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-100'>
        <div className="shadow-lg w-full rounded-2xl p-4 bg-white border m-auto">
          <div className="w-full h-full text-center">
            <form className="flex h-full flex-col justify-between space-y-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center justify-between gap-4 w-full mt-8">
                ...
                <button onClick={() => { toggler() }} type="button" className="py-2 px-4  bg-white hover:bg-gray-100 focus:ring-blue-500 focus:ring-offset-blue-200 text-blue-500 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                  Cancel
                </button>
              </div>
            </form>
