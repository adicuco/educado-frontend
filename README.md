...
```
cd existing_repo
git remote add origin https://gitlab.com/A-tech/educado-frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/A-tech/educado-frontend/-/settings/integrations)
